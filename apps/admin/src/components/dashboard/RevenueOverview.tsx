...
export const RevenueOverview = () => (
  <div className="card" style={{ flex: 2 }}>
    <div className="flex justify-between align-center mb-24">
      <h3 style={{ fontSize: "16px", fontWeight: 600 }}>Revenue Overview</h3>
    ...
    <div className="flex justify-between mb-24" style={{ textAlign: "center" }}>
      <div>
        <p style={{ color: "#999", fontSize: "12px" }}>Bookings</p>
        <strong>
          825 <span style={{ color: "#47B881", fontSize: "10px" }}>↑ 24%</span>
        </strong>
      </div>
      <div>
        <p style={{ color: "#999", fontSize: "12px" }}>Revenue</p>
        <strong>
          $89k <span style={{ color: "#47B881", fontSize: "10px" }}>↑ 24%</span>
        </strong>
      </div>
      <div>
        <p style={{ color: "#999", fontSize: "12px" }}>Expence</p>
        <strong>
          $68k <span style={{ color: "#F64C4C", fontSize: "10px" }}>↓ 24%</span>
        </strong>
      </div>
      <div>
        <p style={{ color: "#999", fontSize: "12px" }}>Profit</p>
        <strong>
