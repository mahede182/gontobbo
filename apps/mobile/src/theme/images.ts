...
export const images = {
  ...
  chat: require("@/assets/bottomTab/chat.png") as ImageSourcePropType,
  chatActive: require("@/assets/bottomTab/chatActive.png") as ImageSourcePropType,
  ...
  onboardOne: require("@/assets/init/initOne.png") as ImageSourcePropType,
  onboardTwo: require("@/assets/init/initTwo.png") as ImageSourcePropType,
  onboardThree: require("@/assets/init/initThree.png") as ImageSourcePropType,
